...
.. image:: https://img.shields.io/badge/SAL-API-gray.svg
    :target: https://ts-xml.lsst.io/sal_interfaces/ATSpectrograph.html
.. image:: https://img.shields.io/badge/GitHub-gray.svg
    :target: https://github.com/lsst-ts/ts_atspec
.. image:: https://img.shields.io/badge/Jira-gray.svg
    :target: https://jira.lsstcorp.org/issues/?jql=labels+%3D+ts_atspec
.. image:: https://img.shields.io/badge/Jenkins-gray.svg
    :target: https://tssw-ci.lsst.org/job/LSST_Telescope-and-Site/job/ts_atspec/
...
:ref:`Contact info <ts_xml:index:master-csc-table:ATSpectrograph>`
...
.. note:: If you are interested in viewing other branches of this repository append a `/v` to the end of the url link. For example `https://ts_atspec.lsst.io/v/`
...
User-level documentation, found at the link below, is aimed at personnel looking to perform the standard use-cases/operations with the ATSpectrograph.
...
Configuring the ATSpectrograph
=========================================
...
The configuration for the ATSpectrograph is described at the following link.
...
This area of documentation focuses on the classes used, API's, and how to participate to the development of the ATSpectrograph software packages.
...
The version history of the ATSpectrograph is found at the following link.
