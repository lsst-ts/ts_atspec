...
#########################################
ATSpectrograph Developer Guide
#########################################
...
.. automodapi:: lsst.ts.atspectrograph
    :no-main-docstr:
...
Updating Firmware of the ATSpectrograph
==================================================
...
Feature requests can be made by filing a Jira ticket with the `ATSpectrograph` label.
In all cases, reaching out to the :ref:`contacts for this CSC <ts_xml:index:master-csc-table:ATSpectrograph>` is recommended.
